# SYSTEM ARCHITECTURE SPECIFICATION — CURRENT STATE
...
**⚠️ IMPORTANT:** This document describes the system architecture **AS IT EXISTS TODAY** before any migration work. This is the baseline snapshot for Sprint 0. Do not modify this document during migration sprints.
